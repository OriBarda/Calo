...
-- CreateTable for meal templates
...
-- CreateTable for user meal plans
...
-- CreateTable for meal plan schedules
...
-- CreateTable for user meal preferences
...
-- CreateTable for shopping lists
...
CREATE INDEX "meal_plan_schedules_day_timing_idx" ON "meal_plan_schedules"("day_of_week", "meal_timing");
CREATE INDEX "user_meal_preferences_user_template_idx" ON "user_meal_preferences"("user_id", "template_id");
...
ALTER TABLE "user_meal_preferences" ADD CONSTRAINT "user_meal_preferences_user_template_type_key" UNIQUE ("user_id", "template_id", "preference_type");

ALTER TABLE "meal_plan_schedules" ADD CONSTRAINT "meal_plan_schedules_plan_day_timing_order_key" UNIQUE ("plan_id", "day_of_week", "meal_timing", "meal_order");